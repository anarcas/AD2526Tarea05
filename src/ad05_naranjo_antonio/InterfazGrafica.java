...
public class InterfazGrafica extends javax.swing.JFrame {
    ...
    /**
     * Este método limpia la interfaz de usuario. Busca todos los campos de
     * texto y listas desplegables para vaciarlos, dejando la pantalla preparada
     * para una nueva sesión.
     */
    private void limpiarInterfaz(Container contenedor, Container panelExcluido) {
        // Recorre todos los componentes que contiene el panel actual.
        for (Component c : contenedor.getComponents()) {

            // Comprueba si el componente es un área de texto y lo vacía.
            if (c instanceof JTextArea) {
                ((JTextArea) c).setText("");
            } // Elimina todos los elementos de la lista desplegable.
            else if (c instanceof JComboBox) {
                ((JComboBox<?>) c).removeAllItems();
            } // Limpia los campos de texto, siempre que no pertenezcan al panel excluido.
            else if (c instanceof JTextField) {
                if (c.getParent() != panelExcluido) {
                    ((JTextField) c).setText("");
                }
            } // Continúa buscando componentes dentro de otros paneles o grupos. Aplica el método de manera recursiva.
            else if (c instanceof Container) {
                limpiarInterfaz((Container) c, panelExcluido);
            }
        }
    }
    ...
    private void initComponents() {
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addGap(27, 27, 27)
                                .addComponent(jTextFieldDirectorioBDxml, javax.swing.GroupLayout.DEFAULT_SIZE, 248, Short.MAX_VALUE))
                            .addGroup(jPanel1Layout.createSequentialGroup()
        ...
        jPanelEntidad.setBorder(javax.swing.BorderFactory.createBevelBorder(javax.swing.border.BevelBorder.RAISED));
        ...
        jPanelXpath.setBorder(javax.swing.BorderFactory.createBevelBorder(javax.swing.border.BevelBorder.RAISED));
        ...
        jPanelXpath1.setBorder(javax.swing.BorderFactory.createBevelBorder(javax.swing.border.BevelBorder.RAISED));
        ...
        jPanelXpath2.setBorder(javax.swing.BorderFactory.createBevelBorder(javax.swing.border.BevelBorder.RAISED));
        ...
        jPanelXpath3.setBorder(javax.swing.BorderFactory.createBevelBorder(javax.swing.border.BevelBorder.RAISED));
                ...
                .addGroup(jPanelXpath3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanelXpath3Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanelXpath3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanelXpath3Layout.createSequentialGroup()
                                .addComponent(jComboBoxNombresProductos, javax.swing.GroupLayout.PREFERRED_SIZE, 200, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(0, 0, Short.MAX_VALUE)))
                        .addContainerGap())))
        );
    ...
    private void jButtonCerrarBDActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonCerrarBDActionPerformed
        ...
        if (confirmacion == JOptionPane.YES_OPTION) {
            ...
            // Se determina el panel que contiene el botón de cerrar para protegerlo de la limpieza.
            // No se borrarán los nombres de las entidades y rutas xPath
            Container panelExclusivo = jButtonCerrarBD.getParent();

            // Se llama al método de limpieza enviando la ventana principal y el panel protegido.
            limpiarInterfaz(this.getContentPane(), panelExclusivo);
